...
const sendMailSuccessService = async (emails, data, subject) => {
  const transporter = nodemailer.createTransport({
    host: "smtp.gmail.com",
    port: 587,
    secure: false, // true for port 465, false for other ports
        ...
        <div class="card">
            ...
            <div class="info">
                ...
                <div class="info-row">
                    ...
                    <span class="value">${nameServiceCategory}</span>
                </div>
              <div class="info-row">
                    <span class="label">Dịch uvj:</span>
                    <span class="value">${nameService}</span>
                </div>
                <div class="info-row">
                    <span class="label">Ngày khám:</span>
                    <span class="value">${appointmentDateString}</span>
...
const sendMailVerifyService = async (emails, data, subject) => {
  const transporter = nodemailer.createTransport({
    host: "smtp.gmail.com",
    port: 587,
    secure: false, // true for port 465, false for other ports
...
<body>
    <div class="container">
        <div class="card">
            ...
            <a href="${webLink}/booking/confirmBookingService?bookingId=${bookingId}&serviceId=${serviceId}&appointmentDate=${appointmentDateString}&timeType=${timeType}" style="text-decoration: none;">
                <button class="button button-verify">Xác nhận</button>
            </a>
            <div class="info">
                <div class="info-row">
...
const sendMailReminderService = async (email, data, subject) => {
  const transporter = nodemailer.createTransport({
    host: "smtp.gmail.com",
    port: 587,
    secure: false, // true for port 465, false for other ports
  ...
  const info = await transporter.sendMail({
    ...
    <ul>
      <li><strong>Ngày khám:</strong> ${appointmentDate}</li>
      <li><strong>Giờ khám:</strong> ${timeRange}</li>
      <li><strong>Loại dịch vụ:</strong> ${serviceCategoryName}</li>
...
export default {
  ...
  sendMailReminder,
  sendMailSuccessService,
  sendMailVerifyService,
  sendMailReminderService,
};
